...
const SettingsIcon = () => {
    return <Svg width="24" height="24" viewBox="0 0 24 24" fill="none">
        <G id="Iconly/Light/Filter">
            <G id="Filter">
                <Path id="Stroke 1" d="M10.33 16.5929H4.0293" stroke="#130F26" stroke-width="1.5" stroke-linecap="round"
                      stroke-linejoin="round"/>
                <Path id="Stroke 3" d="M13.1406 6.90042H19.4413" stroke="#130F26" stroke-width="1.5"
